...
export const metadata: Metadata = {
  title: "About DXB Runners Cargo | Reliable Freight & Cargo",
  description:
    "Learn about DXB Runners Cargo. We provide reliable freight and cargo services from UAE & China to Zimbabwe with secure handling, trusted sourcing, and professional logistics support.",
  alternates: {
    canonical: "https://www.dxbrunnerscargo.com/about",
  },
  openGraph: {
    type: "website",
    url: "https://www.dxbrunnerscargo.com/about",
    title: "About DXB Runners Cargo | Reliable Freight & Cargo",
    description:
      "Learn about DXB Runners Cargo. We provide reliable freight and cargo services from UAE & China to Zimbabwe with secure handling, trusted sourcing, and professional logistics support.",
  },
...
const milestones = [
  {
    ...
    description: "DXB Runners Cargo was established to bridge the gap between UAE suppliers and African markets.",
  },
  {
    year: "2016",
  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="relative">
              <div className="absolute -bottom-3 -right-3 w-full h-full rounded-3xl bg-[#1B0A2E]/08 -z-10" />
              <div className="relative aspect-[4/3] overflow-hidden rounded-3xl shadow-2xl shadow-slate-200/70">
                <Image
                  src="/dxb-warehouse.jpg"
                  alt="DXB Runners Cargo Warehouse Operations"
                  fill
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-5 left-6 inline-flex items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-[#1B0A2E] text-white shadow-xl shadow-[#1B0A2E]/30">
            ...
            <div className="pt-6 lg:pt-0">
              <div className="w-12 h-12 rounded-2xl bg-[#1B0A2E]/08 border border-[#1B0A2E]/10 flex items-center justify-center mb-5">
                <Globe className="w-6 h-6 text-[#1B0A2E]" />
              </div>
              <p className="font-mono text-[10px] font-bold tracking-[0.18em] text-[#9333EA] uppercase mb-2">
                Building Bridges Between Continents
              </p>
              <h2 className="text-2xl md:text-3xl font-black text-[#1B0A2E] tracking-tight mb-4 leading-tight">
                Who We Are
              </h2>
              <div className="space-y-4 text-slate-500 text-base leading-relaxed">
                <p>
                  At DXB Runners Cargo, we understand the challenges businesses face when sourcing
              ...
              <div className="mt-8">
                <a
                  ...
                  className="inline-flex items-center gap-2.5 px-6 py-3 rounded-xl bg-[#1B0A2E] text-white text-sm font-bold tracking-wide hover:bg-[#9333EA] active:scale-95 transition-all duration-200 shadow-lg shadow-[#1B0A2E]/20"
                >
                  Get in Touch
      ...
      <section className="bg-slate-50 border-t border-slate-100 py-16 lg:py-20">
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-12">
            <p className="text-[#9333EA] text-[10px] font-black tracking-[0.22em] uppercase mb-2">Our Values</p>
            <h2 className="text-2xl md:text-3xl font-black text-[#1B0A2E] tracking-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {values.map((value) => (
              <div
                key={value.title}
                className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-[#1B0A2E]/15 hover:-translate-y-0.5 transition-all duration-200 text-center"
              >
                <div className="w-12 h-12 rounded-xl bg-[#1B0A2E]/07 flex items-center justify-center">
                  <value.icon className="w-6 h-6 text-[#1B0A2E]" />
                </div>
                <h3 className="text-sm font-bold text-[#1B0A2E] leading-snug">{value.title}</h3>
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            <p className="text-[#9333EA] text-[10px] font-black tracking-[0.22em] uppercase mb-2">Our Journey</p>
            <h2 className="text-2xl md:text-3xl font-black text-[#1B0A2E] tracking-tight">
                ...
                {milestones.map((milestone, index) => (
                  ...
                  >
                    ...
                    <div className="absolute left-8 top-0 -translate-x-1/2 md:left-1/2">
                      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#1B0A2E] shadow-lg shadow-[#1B0A2E]/30">
                    ...
                    <div className={`ml-16 md:ml-0 md:w-1/2 ${index % 2 === 0 ? "md:pr-16" : "md:pl-16"}`}>
                      <div className="rounded-2xl border border-slate-100 bg-white shadow-sm hover:shadow-md hover:border-[#1B0A2E]/15 hover:-translate-y-0.5 transition-all duration-200 p-6">
                        <span className="text-2xl font-black text-[#9333EA]">{milestone.year}</span>
                        <h3 className="mt-2 text-base font-bold text-[#1B0A2E]">{milestone.title}</h3>
      ...
      <section className="bg-slate-50 border-t border-slate-100 py-16 lg:py-20">
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-12">
            <p className="text-[#9333EA] text-[10px] font-black tracking-[0.22em] uppercase mb-2">Global Presence</p>
            <h2 className="text-2xl md:text-3xl font-black text-[#1B0A2E] tracking-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              >
                ...
                <h3 className="text-sm font-bold text-[#1B0A2E] leading-snug">{office.location}</h3>
