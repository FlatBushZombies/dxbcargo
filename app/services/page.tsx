...
export const metadata: Metadata = {
  title: "Our Services | DXB Runners Cargo",
    ...
    <main className="min-h-screen bg-white">
                ...
                >
                  ...
                  <div className={`pt-6 lg:pt-0 ${!even ? "lg:[grid-area:content]" : ""}`}>
                    ...
                    <div className="w-12 h-12 rounded-2xl bg-[#1B0A2E]/08 border border-[#1B0A2E]/10 flex items-center justify-center mb-5">
                      <service.icon className="w-6 h-6 text-[#1B0A2E]" />
                    </div>
                    ...
                    <ul className="grid sm:grid-cols-2 gap-2.5 mb-8">
                      {service.features.map((feature) => (
                        <li key={feature} className="flex items-center gap-2.5">
                          <div className="w-5 h-5 rounded-full bg-[#1B0A2E]/08 flex items-center justify-center shrink-0">
                            <CheckCircle2 className="w-3 h-3 text-[#1B0A2E]" />
                          </div>
      ...
      <section className="bg-slate-50 border-t border-slate-100 py-16 lg:py-20">
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-12">
            <p className="text-[#9333EA] text-[10px] font-black tracking-[0.22em] uppercase mb-2">All Services</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {services.map((service) => (
              <div
                key={service.title}
                className="flex flex-col items-center gap-2.5 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-[#1B0A2E]/15 hover:-translate-y-0.5 transition-all duration-200 text-center"
              >
                <div className="w-10 h-10 rounded-xl bg-[#1B0A2E]/07 flex items-center justify-center">
                  <service.icon className="w-5 h-5 text-[#1B0A2E]" />
                </div>
                <span className="text-[11px] font-bold text-[#1B0A2E] leading-snug">{service.title}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative bg-[#1B0A2E] py-20 lg:py-28 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-[500px] h-[500px] rounded-full bg-purple-500/08 blur-3xl" />
        </div>
        {/* Top edge */}
