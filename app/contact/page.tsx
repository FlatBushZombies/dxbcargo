...
const inputCls =
  "w-full rounded-xl border border-slate-200 bg-white px-4 py-3.5 text-[#1B0A2E] text-sm placeholder:text-slate-400 outline-none transition-all focus:border-[#9333EA] focus:ring-2 focus:ring-[#9333EA]/10 shadow-sm min-h-[48px]"

const StepBadge = ({ n }: { n: number }) => (
  <span className="w-8 h-8 rounded-full bg-[#1B0A2E] flex items-center justify-center text-white text-xs font-black shadow-md shadow-[#1B0A2E]/25 shrink-0">
    {n}
  </span>
)
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[480px] sm:min-h-[560px] flex items-center overflow-hidden">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-[#1B0A2E]/65" />
        <div
      ...
      <section className="bg-slate-50 py-16 sm:py-20 lg:py-28 border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="text-center mb-10 sm:mb-14">
            <p className="text-[#9333EA] text-[10px] font-black tracking-[0.22em] uppercase mb-2">Quick Quote</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#1B0A2E] tracking-tight mb-3">
          ...
          <div className="rounded-2xl sm:rounded-3xl bg-white border border-slate-100 shadow-2xl shadow-slate-200/60 overflow-hidden">
            ...
            <div className="px-5 sm:px-8 pt-7 sm:pt-8 pb-6 sm:pb-7 border-b border-slate-100">
              <div className="flex items-center gap-3 mb-5 sm:mb-6">
                <StepBadge n={1} />
                <h3 className="text-sm sm:text-base font-bold text-[#1B0A2E]">Select Services You Need</h3>
              </div>
                  ...
                  return (
                    <button
                      ...
                      className={`group flex items-center gap-2.5 sm:gap-3 rounded-xl border-2 p-3 sm:p-4 text-left transition-all duration-200 ${
                        active
                          ? "border-[#1B0A2E] bg-[#1B0A2E]/[0.04] shadow-sm"
                          : "border-slate-150 bg-slate-50 hover:border-[#1B0A2E]/40 hover:bg-white"
                      }`}
                    >
                      <div className={`w-8 h-8 sm:w-9 sm:h-9 rounded-lg flex items-center justify-center shrink-0 transition-colors ${
                        active ? "bg-[#1B0A2E] text-white" : "bg-slate-200 text-slate-500 group-hover:bg-[#1B0A2E]/10 group-hover:text-[#1B0A2E]"
                      }`}>
                        <service.icon className="w-4 h-4" />
                      </div>
                      <span className={`text-xs sm:text-sm font-semibold leading-snug flex-1 ${active ? "text-[#1B0A2E]" : "text-slate-600"}`}>
                        {service.label}
                      </span>
                      {active && <CheckCircle2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#1B0A2E] shrink-0" />}
                    </button>
                  )
                })}
              </div>
            ...
            <div className="px-5 sm:px-8 pt-6 sm:pt-7 pb-6 sm:pb-7 border-b border-slate-100">
              <div className="flex items-center gap-3 mb-5 sm:mb-6">
                <StepBadge n={2} />
                <h3 className="text-sm sm:text-base font-bold text-[#1B0A2E]">Your Details</h3>
              </div>
              <div className="flex flex-col gap-4">
                {/* Name — full width on mobile, half on md */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] sm:text-xs font-bold text-[#1B0A2E]/70 tracking-wide uppercase mb-1.5">Full Name *</label>
                    <input
                      type="text"
                      value={formData.name}
                  ...
                  <div>
                    <label className="block text-[10px] sm:text-xs font-bold text-[#1B0A2E]/70 tracking-wide uppercase mb-1.5">Email</label>
                    <input
                      type="email"
                ...
                <div>
                  <label className="block text-[10px] sm:text-xs font-bold text-[#1B0A2E]/70 tracking-wide uppercase mb-1.5">WhatsApp / Phone Number *</label>
                  <input
                    type="tel"
            ...
            <div className="px-5 sm:px-8 pt-6 sm:pt-7 pb-6 sm:pb-7 border-b border-slate-100">
              <div className="flex items-center gap-3 mb-5 sm:mb-6">
                <StepBadge n={3} />
                <h3 className="text-sm sm:text-base font-bold text-[#1B0A2E]">Shipment Details</h3>
              </div>
              <div className="flex flex-col gap-4">
                {/* Origin + Destination — stacked on mobile, side by side on sm+ */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] sm:text-xs font-bold text-[#1B0A2E]/70 tracking-wide uppercase mb-1.5">Origin (From)</label>
                    <select
                  ...
                  <div>
                    <label className="block text-[10px] sm:text-xs font-bold text-[#1B0A2E]/70 tracking-wide uppercase mb-1.5">Destination (To)</label>
                    <select
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] sm:text-xs font-bold text-[#1B0A2E]/70 tracking-wide uppercase mb-1.5">Type of Cargo</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-[10px] sm:text-xs font-bold text-[#1B0A2E]/70 tracking-wide uppercase mb-1.5">Estimated Weight</label>
                    <input
                      type="text"
                ...
                <div>
                  <label className="block text-[10px] sm:text-xs font-bold text-[#1B0A2E]/70 tracking-wide uppercase mb-1.5">Additional Details</label>
                  <textarea
            ...
            <div className="bg-slate-50 px-5 sm:px-8 py-5 sm:py-6">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                <div className="text-center sm:text-left">
                  <p className="font-bold text-[#1B0A2E] text-sm">Ready to get your quote?</p>
      ...
      <section className="bg-white py-16 sm:py-20 lg:py-28">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="text-center mb-10 sm:mb-14">
            <p className="text-[#9333EA] text-[10px] font-black tracking-[0.22em] uppercase mb-2">Contact Methods</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#1B0A2E] tracking-tight">
              Reach Us Directly
            </h2>
          </div>
              ...
              >
                <div className={`w-11 h-11 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center mb-4 sm:mb-5 ${
                  method.highlight
                    ...
                    : "bg-[#1B0A2E]/[0.08] text-[#1B0A2E]"
                }`}>
                  <method.icon className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <h3 className="text-xs sm:text-sm font-black text-[#1B0A2E] mb-1">{method.title}</h3>
                <p className="text-slate-400 text-[11px] sm:text-xs mb-1">{method.description}</p>
                <p className="text-[#1B0A2E] font-bold text-xs sm:text-sm mb-4 flex-1 leading-snug">{method.value}</p>
                <a
                  href={method.action}
                  ...
                  className={`flex items-center justify-center gap-2 w-full py-2.5 rounded-xl text-xs sm:text-sm font-bold tracking-wide transition-all duration-200 ${
                    method.highlight
                      ...
                      : "bg-[#1B0A2E] text-white hover:bg-[#9333EA] shadow-md shadow-[#1B0A2E]/20"
                  }`}
                >
                  {method.actionLabel}
                </a>
      ...
      <section className="bg-slate-50 py-16 sm:py-20 lg:py-28 border-t border-slate-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="text-center mb-10 sm:mb-14">
            <p className="text-[#9333EA] text-[10px] font-black tracking-[0.22em] uppercase mb-2">Our Offices</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#1B0A2E] tracking-tight">Visit Us</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-7">
            ...
            <div className="rounded-3xl overflow-hidden bg-white border border-slate-100 shadow-xl shadow-slate-200/50 hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-200/70 transition-all duration-300">
              <div className="relative h-44 sm:h-52">
                ...
                <span className="absolute bottom-4 left-5 px-3 py-1 rounded-full bg-[#1B0A2E] text-white text-[11px] font-bold tracking-wide shadow-lg">
                  Head Office
                </span>
              </div>
              <div className="px-5 sm:px-7 pt-5 pb-6 sm:pb-7">
                <h3 className="text-lg sm:text-xl font-black text-[#1B0A2E] mb-4 sm:mb-5 tracking-tight">Dubai Office (UAE)</h3>
                <div className="space-y-3 mb-5 sm:mb-6">
                  <div className="flex items-start gap-3">
                    <MapPin className="w-4 h-4 text-[#9333EA] mt-0.5 shrink-0" />
                    <span className="text-slate-500 text-sm">Sharjah, United Arab Emirates</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <Phone className="w-4 h-4 text-[#9333EA] mt-0.5 shrink-0" />
                    <span className="text-slate-500 text-sm leading-snug">+971 52 521 0658 / +971 55 993 3478</span>
                  </div>
                </div>
                <a
                  href="tel:+971559933478"
                  className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-[#1B0A2E] text-white text-sm font-bold hover:bg-[#9333EA] transition-colors duration-200 shadow-md shadow-[#1B0A2E]/20"
                >
                  Call Dubai Office
                </a>
              </div>
            ...
            <div className="rounded-3xl overflow-hidden bg-white border border-slate-100 shadow-xl shadow-slate-200/50 hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-200/70 transition-all duration-300">
              <div className="relative h-44 sm:h-52">
                <Image
                  src="/dxb-operations.jpg"
                  alt="Zimbabwe" fill className="object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-white via-white/10 to-transparent" />
                <span className="absolute bottom-4 left-5 px-3 py-1 rounded-full bg-purple-500 text-white text-[11px] font-bold tracking-wide shadow-lg">
                  Collection Point
                </span>
              </div>
              <div className="px-5 sm:px-7 pt-5 pb-6 sm:pb-7">
                <h3 className="text-lg sm:text-xl font-black text-[#1B0A2E] mb-4 sm:mb-5 tracking-tight">Zimbabwe Office</h3>
                <div className="space-y-3 mb-5 sm:mb-6">
                  <div className="flex items-start gap-3">
      ...
      <section className="bg-white py-16 sm:py-20 lg:py-28 border-t border-slate-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="text-center mb-10 sm:mb-14">
            <p className="text-[#9333EA] text-[10px] font-black tracking-[0.22em] uppercase mb-2">FAQ</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#1B0A2E] tracking-tight mb-3">
              ...
              return (
                <div
                  ...
                  className={`rounded-2xl border overflow-hidden transition-all duration-200 ${
                    open ? "border-[#1B0A2E]/20 shadow-md shadow-[#1B0A2E]/[0.08]" : "border-slate-100 bg-white"
                  }`}
                >
                  <button
                  ...
                  >
                    <h3 className={`text-sm font-bold leading-snug transition-colors ${open ? "text-[#1B0A2E]" : "text-slate-700"}`}>
                      {faq.question}
                    </h3>
                    <span className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 transition-all ${
                      open ? "bg-[#1B0A2E] text-white" : "bg-slate-100 text-slate-400"
                    }`}>
      ...
      {/* ── CTA ──────────────────────────────────────────── */}
      <section className="relative bg-[#1B0A2E] py-16 sm:py-20 lg:py-28 overflow-hidden">
        <div
          className="absolute inset-0 opacity-[0.06]"
          style={{ backgroundImage: "radial-gradient(circle, #ffffff 1px, transparent 1px)", backgroundSize: "30px 30px" }}
        />
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-[500px] h-[500px] rounded-full bg-purple-500/[0.08] blur-3xl" />
        </div>
