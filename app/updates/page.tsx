...
const NOTICES: Notice[] = [
  ...
  },
  {
    ...
    summary: "Clients can now track their shipments in real time via the DXB Runners Cargo tracking portal. Access your tracking number from your shipment confirmation email.",
    body: "We are pleased to announce the launch of the DXB Runners Cargo online shipment tracking portal. All clients with active shipments will receive a unique tracking reference in their shipment confirmation email. The portal provides real-time status updates including: customs clearance milestones, departure and arrival scans at each transit hub, estimated delivery window, and document upload functionality for customs submissions. The tracking portal is accessible at dxbrunnerscargo.com/tracking on desktop and mobile. For any issues accessing the portal, please contact our support team.",
    date: "01 Nov 2025",
    region: "Global",
    resolved: true,
  },
            ...
            {!isResolved && (
              <div className="mt-5">
                <a
                  ...
                  className="dxb-btn-primary inline-flex items-center gap-2 rounded-sm px-5 py-2.5 text-xs font-bold uppercase tracking-widest text-white transition-all hover:opacity-90"
                >
...
export default function UpdatesPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F8F8F6]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      {/* ── HERO ─────────────────────────────────────────────────── */}
      <section className="relative overflow-hidden dxb-bg-primary">
        ...
        <div className="container relative mx-auto px-6 pb-16 pt-14 lg:px-12">
          ...
          <p className="mb-10 max-w-lg text-[15px] leading-relaxed text-white/70">
            ...
            <a href="/pricing" className="text-purple-300 underline underline-offset-2 hover:text-white">
              pricing page
            </a>
            .
          </p>
              ...
              {FILTER_OPTIONS.map((opt) => (
                <button
                  ...
                  className={`rounded-none border px-5 py-2 font-mono text-[11px] font-semibold uppercase tracking-[0.12em] transition-all ${
                    filter === opt
                      ? "dxb-filter-active"
                      : "border-gray-300 bg-white text-gray-500 dxb-filter-inactive"
                  }`}
                >
                  {opt}
                </button>
      ...
      <style>{`
        ...
        .dxb-bg-primary        { background-color: #DC2626 !important; }
        .dxb-bg-primary-10     { background-color: rgba(220, 38, 38, 0.10) !important; }
        .dxb-text-primary      { color: #DC2626 !important; }
        .dxb-border-primary    { border-color: #DC2626 !important; }
        .dxb-border-primary-25 { border-color: rgba(220, 38, 38, 0.25) !important; }
        .dxb-ring-primary      { box-shadow: 0 0 0 1px rgba(220, 38, 38, 0.10) !important; }
        ...
        .hover\:shadow-xl:hover {
          --tw-shadow-color: rgba(220, 38, 38, 0.08);
        }
      `}</style>
    </main>
  )
