  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[580px] flex items-center overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-[#1B0A2E] opacity-65" />
        <div
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 lg:px-12 py-32 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-[1.08] tracking-tight mb-6">
            Track Your<br />
            <span className="text-purple-300">Shipment</span>
          </h1>
          ...
          <form onSubmit={handleSearch} className="max-w-xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button
                ...
                className="h-14 px-8 bg-white text-[#1B0A2E] font-bold rounded-2xl hover:bg-slate-100 transition-all duration-200 shadow-lg shadow-black/20"
              >
                {isSearching ? (
                  <span className="flex items-center gap-2">
                    <span className="w-4 h-4 border-2 border-[#1B0A2E]/30 border-t-[#1B0A2E] rounded-full animate-spin" />
                    Searching...
                  </span>
                ) : (
                  <span className="flex items-center gap-2">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="appearance-none h-10 pl-3 pr-9 rounded-xl bg-white/10 border border-white/20 text-white text-sm focus:outline-none focus:ring-2 focus:ring-purple-300/40"
                    >
                      <option value="all" className="text-[#1B0A2E]">All Statuses</option>
                      {TRACKING_STATUSES.map((status) => (
                        <option key={status.value} value={status.value} className="text-[#1B0A2E]">
                          {status.label}
                        </option>
                      ))}
                    </select>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="appearance-none h-10 pl-3 pr-9 rounded-xl bg-white/10 border border-white/20 text-white text-sm focus:outline-none focus:ring-2 focus:ring-purple-300/40"
                    >
                      <option value="all" className="text-[#1B0A2E]">All Transport</option>
                      <option value="Air" className="text-[#1B0A2E]">Air</option>
                      <option value="Sea" className="text-[#1B0A2E]">Sea</option>
                      <option value="Air Dangerous Goods" className="text-[#1B0A2E]">Air Dangerous Goods</option>
                    </select>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className={`rounded-2xl p-5 ${getStatusColor(latestStatus.status).replace('bg-', 'bg-')}/10 border border-${getStatusColor(latestStatus.status).replace('bg-', '')}/20`}>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-[#1B0A2E]">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="col-span-2 bg-slate-50 rounded-xl p-4 border border-slate-100">
                    ...
                    <p className="text-sm text-[#1B0A2E] leading-relaxed whitespace-pre-wrap">
                  ...
                  <div className="bg-slate-50 rounded-xl p-3">
                    ...
                    <p className="text-sm font-semibold text-[#1B0A2E]">
                  ...
                  <div className="bg-slate-50 rounded-xl p-3">
                    ...
                    <p className="text-sm font-semibold text-[#1B0A2E]">{searchedPackage.transport_type}</p>
                  </div>
                  {searchedPackage.batch_number && (
                    <div className="bg-slate-50 rounded-xl p-3">
                      ...
                      <p className="text-sm font-semibold text-[#1B0A2E]">{searchedPackage.batch_number}</p>
                    </div>
                  )}
                  <div className="bg-slate-50 rounded-xl p-3">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-sm font-semibold text-[#1B0A2E]">{searchedPackage.ctn_quantity}</p>
                  </div>
                  {searchedPackage.weight && (
                    <div className="bg-slate-50 rounded-xl p-3">
                      ...
                      <p className="text-sm font-semibold text-[#1B0A2E]">{searchedPackage.weight} kg</p>
                    </div>
                  )}
            ...
            <div className="p-6 border-t border-slate-100 flex gap-3">
              ...
              <a
                ...
                className="flex-1"
              >
                <Button className="w-full h-12 rounded-xl bg-[#1B0A2E] hover:bg-[#3B1A5C]">
                  Contact Support
                </Button>
              </a>
            </div>
        ...
        <div ref={routeRevealRef} className="max-w-5xl mx-auto px-6 lg:px-12 text-center">
          ...
          <div data-reveal className="max-w-lg mx-auto">
            <div className="flex items-end justify-between px-2 mb-3">
              ...
              <div className="text-center">
                <div className="w-20 h-20 rounded-2xl bg-purple-500/20 border border-purple-400/35 flex items-center justify-center mx-auto mb-2 shadow-lg">
                  <span className="text-purple-300 font-mono font-bold text-lg tracking-widest">HRE</span>
                </div>
            ...
            <div className="relative h-36">
              ...
              >
                ...
                <circle cx="720" cy="90" r="5" fill="#9333EA" />
                ...
                <g ref={planeRef}>
                  <g transform="translate(-14, -14) rotate(90, 14, 14)">
                    ...
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="#9333EA">
              ...
              >
                ...
                <div className="bg-white px-7 pt-7 pb-5 flex items-start justify-between gap-4">
                  <div>
                    ...
                    <h3 className="text-2xl font-black text-[#1B0A2E] tracking-tight leading-none">{flight.day}</h3>
                    <p className="text-gray-400 text-sm mt-1.5 font-light">{flight.route}</p>
                  </div>
                  <div className="flex-shrink-0 w-20 h-20 rounded-2xl bg-[#1B0A2E] flex flex-col items-center justify-center shadow-lg shadow-[#1B0A2E]/30">
                ...
                <div className="mx-6 mb-6 rounded-2xl bg-slate-50 border border-slate-100 px-6 py-5">
                  <div className="flex items-center gap-3">
                    <div className="text-center shrink-0">
                      <div className="w-14 h-14 rounded-xl bg-[#1B0A2E] flex items-center justify-center mx-auto mb-2 shadow-md shadow-[#1B0A2E]/25">
                        <span className="text-white font-mono font-bold text-sm tracking-wide">{flight.from}</span>
                      </div>
                      <p className="text-[#1B0A2E] font-bold text-sm leading-none">{flight.departureTime}</p>
                      <p className="text-gray-400 text-[11px] mt-0.5">Departure</p>
                    </div>

                    <div className="flex-1 flex flex-col items-center gap-1.5">
                      <div className="relative w-full h-px bg-[#1B0A2E]/12">
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-7 h-7 rounded-full bg-white border border-[#1B0A2E]/15 flex items-center justify-center shadow-sm">
                          <Plane className="w-3 h-3 text-[#9333EA]" />
                        </div>
                      </div>
                    ...
                    <div className="text-center shrink-0">
                      <div className="w-14 h-14 rounded-xl bg-purple-500 flex items-center justify-center mx-auto mb-2 shadow-md shadow-purple-500/30">
                        <span className="text-white font-mono font-bold text-sm tracking-wide">{flight.to}</span>
                      </div>
                      <p className="text-[#1B0A2E] font-bold text-sm leading-none">{flight.arrivalTime}</p>
                ...
                <div className="px-6 pb-7">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-[#1B0A2E] text-white text-sm font-bold tracking-wide hover:bg-[#9333EA] active:scale-95 transition-all duration-200 shadow-lg shadow-[#1B0A2E]/20"
                  >
                    Book This Flight
                    <ArrowRight className="w-4 h-4" />
                  </a>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {trackingSteps.map((step, i) => (
              ...
              >
                ...
                <p className="font-mono text-6xl font-black text-[#1B0A2E]/[0.05] leading-none mb-3 select-none -ml-1">
                  {step.num}
                </p>
                <div className="w-11 h-11 rounded-xl bg-[#1B0A2E]/08 border border-[#1B0A2E]/10 flex items-center justify-center mb-4">
                  <step.icon className="w-5 h-5 text-[#1B0A2E]" />
                </div>
                <h3 className="text-[#1B0A2E] font-bold text-sm mb-1.5 leading-snug">{step.title}</h3>
      ...
      {/* CTA */}
      <section className="relative bg-[#1B0A2E] py-20 lg:py-28 overflow-hidden">
        <div
        ...
        <div ref={ctaRevealRef} className="relative z-10 max-w-3xl mx-auto px-6 lg:px-12 text-center">
          ...
          <div data-reveal className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 px-8 py-4 rounded-full bg-white text-[#1B0A2E] font-black text-sm tracking-wide hover:bg-slate-100 active:scale-95 transition-all duration-200 shadow-2xl shadow-black/30"
            >
