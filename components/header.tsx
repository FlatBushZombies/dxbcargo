...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      ...
      {/* ── Top Utility Bar ── */}
      <div className="hidden lg:block" style={{ backgroundColor: "#DC2626" }}>
        ...
        <div className="container mx-auto flex h-20 items-center justify-between px-4 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 lg:flex">
            {navLinks.map((link) => (
              <Link
                ...
                style={{ "--tw-hover-color": "#DC2626" } as React.CSSProperties}
                onMouseEnter={e => (e.currentTarget.style.color = "#DC2626")}
                onMouseLeave={e => (e.currentTarget.style.color = "")}
              >
                <span
                  className="[&>span]:after:bg-[#DC2626]"
                  style={{}}
                >
                  {link.label}
                </span>
          ...
          <div className="hidden items-center gap-4 lg:flex">
            <Button
              asChild
              size="lg"
              className="rounded-full px-6 text-white transition-all hover:opacity-90 active:scale-95"
      ...
      {/* ── Mobile Menu ── */}
      {isMenuOpen && (
        <div className="animate-in fade-in slide-in-from-top-2 duration-200 ease-out border-t border-border bg-background lg:hidden">
          <nav className="container mx-auto flex flex-col gap-4 px-4 py-6">
            ...
            <div className="flex flex-col gap-3 text-sm text-muted-foreground">
              ...
              <a href="mailto:info@dxbrunnerscargo.com" className="flex items-center gap-2">
                <Mail className="h-4 w-4" />
                info@dxbrunnerscargo.com
              </a>
            </div>
            <Button asChild className="w-full rounded-full text-white transition-all hover:opacity-90 active:scale-95" style={{ backgroundColor: "#DC2626" }}>
