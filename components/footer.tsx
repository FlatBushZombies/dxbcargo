...
export function Footer() {
  return (
    <footer style={{ background: "#10051F", color: "#fff" }}>
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1 flex flex-col gap-5">
            <Image
              ...
              width={160}
              height={45}
              className="max-h-24 w-auto object-contain justify-center"
            />
            <p style={{ color: "rgba(255,255,255,0.55)", fontSize: "0.85rem", lineHeight: "1.7" }}>
              Your trusted freight and cargo partner. DXB Runners Cargo delivers excellence from UAE &amp; China to Zimbabwe with reliable sourcing, secure handling, and fast delivery.
            </p>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.10)" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-16 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p style={{ color: "rgba(255,255,255,0.38)", fontSize: "12px" }}>
            © {new Date().getFullYear()} DXB Runners Cargo. All rights reserved.
          </p>
          <div className="flex items-center gap-2.5">
            <a
              href="https://www.facebook.com/dxbrunnerscargo"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="DXB Runners Cargo on Facebook"
            ...
            <a
              href="https://www.instagram.com/dxbrunnerscargo"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="DXB Runners Cargo on Instagram"
              className="transition-transform hover:-translate-y-0.5"
              style={{
                width: 34,
                height: 34,
