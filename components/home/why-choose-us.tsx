  ...
  return (
    <section className="bg-slate-50 border-t border-slate-100 py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div ref={revealRef} className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div data-reveal className="relative">
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-3xl shadow-2xl shadow-slate-300/60">
              <Image
                ...
                alt="DXB Runners Cargo Operations Offices"
                fill
            ...
            <div className="absolute -bottom-5 -right-5 md:-bottom-7 md:-right-7 hidden md:flex flex-col items-center justify-center w-28 h-28 rounded-2xl bg-[#1B0A2E] text-white shadow-2xl shadow-[#1B0A2E]/40">
              <span className="text-3xl font-black text-purple-300 leading-none">10+</span>
            ...
            <div
              ...
              style={{
                backgroundImage: "radial-gradient(circle, #1B0A2E 1.5px, transparent 1.5px)",
          ...
          <div data-reveal>
            ...
            <h2 className="text-3xl md:text-4xl font-black text-[#1B0A2E] tracking-tight leading-tight mb-5">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="flex gap-3.5 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-[#1B0A2E]/12 transition-all duration-200"
                >
                  <div className="w-10 h-10 rounded-xl bg-[#1B0A2E]/08 border border-[#1B0A2E]/10 flex items-center justify-center shrink-0">
                    <feature.icon className="w-5 h-5 text-[#1B0A2E]" />
                  </div>
                  <div>
                    <h3 className="text-sm font-bold text-[#1B0A2E] mb-1 leading-snug">{feature.title}</h3>
