...
export function StatsSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#1B0A2E] py-20 lg:py-28">
      ...
      />
      {/* Navy overlay */}
      <div className="absolute inset-0 bg-[#1B0A2E]/70" />
      {/* Dot grid */}
      <div
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-[600px] h-[600px] rounded-full bg-purple-500/10 blur-3xl" />
      </div>
      {/* Top & bottom edge lines */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/15 to-transparent" />
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent" />

      <div ref={revealRef} className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">

        {/* Header */}
        <div data-reveal className="text-center max-w-3xl mx-auto mb-16">
          <p className="text-purple-400 text-[10px] font-black tracking-[0.22em] uppercase mb-2">
            Our Impact
          </p>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {stats.map((stat) => (
            ...
            >
              <div className="text-4xl lg:text-5xl font-black text-purple-300 leading-none mb-2">{stat.value}</div>
