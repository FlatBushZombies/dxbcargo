...
export function HeroSection() {
  ...
  return (
    <>
      ...
      {/* ═══════════════════════════ SECTION ═══════════════════════════ */}
      <section className="relative overflow-hidden min-h-svh bg-[#10051F] font-['DM_Sans',sans-serif]">
        ...
        <div className="absolute top-28 right-16 lg:right-24 z-20 hidden lg:flex items-center gap-3">
          ...
          <span className="font-['DM_Sans',sans-serif] font-light tracking-[0.15em] text-[10px] uppercase text-[rgba(240,237,232,0.55)]">
            <span className="font-['Bebas_Neue',sans-serif] tracking-[0.02em] text-xl text-[#9333EA]">
          ...
          {sliderImages.map((image, index) => (
            <button
              ...
              className={[
                ...
                currentSlide === index
                  ? "h-[88px] w-32 outline outline-[1.5px] outline-offset-2 outline-[#9333EA]"
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-2">
                <span className={[
                  ...
                  currentSlide === index ? "text-[#9333EA]" : "text-[rgba(240,237,232,0.55)]",
                ].join(" ")}>
                  {image.tag}
                </span>
                {currentSlide === index && (
              ...
              {currentSlide === index && (
                <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-white/10">
                  <div
                    ref={progressRef}
                    className="h-full origin-left bg-[#9333EA]"
        ...
        <div className="absolute bottom-24 left-1/2 z-20 flex -translate-x-1/2 items-center gap-2 lg:hidden">
          {sliderImages.map((_, index) => (
            ...
            >
              {currentSlide === index && (
                <div className="h-ticker-bar absolute inset-0 origin-left bg-[#9333EA]" />
              )}
            </button>
          ))}
        </div>
          ...
          <div className="max-w-2xl xl:max-w-3xl">
            ...
            <div ref={badgeRef} className="mb-7 inline-flex items-center gap-2.5" style={{ opacity: 0 }}>
              <div className="flex items-center gap-2 rounded-full px-4 py-1.5 border border-[rgba(27,79,216,0.25)] bg-[rgba(6,12,26,0.5)] backdrop-blur-[10px]">
                <span className="animate-pulse h-1.5 w-1.5 rounded-full bg-[#9333EA]" />
            ...
            >
              Your Cargo,{" "}
              <span className="text-[#9333EA]">Our</span>
              <br />
              Commitment.{" "}
              <span
                className="relative inline-block text-[#F0EDE8]"
                style={{ WebkitTextStroke: "1px rgba(147,51,234,0.45)" }}
              >
                Delivered.
              </span>
            </h1>
            ...
            <div ref={highlightsRef} className="mb-10 flex flex-wrap gap-3" style={{ opacity: 0 }}>
              {highlights.map((item) => (
                ...
                >
                  <CheckCircle2 className="h-4 w-4 flex-shrink-0 text-[#9333EA]" />
            ...
            <div ref={ctaRef} className="flex flex-col gap-3 sm:flex-row" style={{ opacity: 0 }}>
              <a
                ...
                className="
                  ...
                  hover:bg-[#7E22CE] hover:-translate-y-px hover:shadow-[0_8px_30px_rgba(147,51,234,0.45)]
          ...
          <div ref={statsRef} className="mt-20 grid grid-cols-2 gap-3 md:grid-cols-4" style={{ opacity: 0 }}>
            {[
              ...
              >
                ...
                <div
                  className="font-['Bebas_Neue',sans-serif] tracking-[0.02em] mb-1 leading-none text-[#9333EA]"
