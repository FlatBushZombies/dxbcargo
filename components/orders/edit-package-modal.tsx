      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
          <div className="p-8 text-center">
            ...
            <h2 className="text-2xl font-black text-[#1B0A2E] mb-2">Package Updated</h2>
            ...
            <Button onClick={onSuccess} className="w-full h-12 rounded-xl bg-[#1B0A2E] hover:bg-[#3B1A5C]">
              Done
            </Button>
          </div>
        </div>
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] overflow-hidden flex flex-col">
        <div className="flex items-center justify-between p-6 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-[#1B0A2E]">Edit Package</h2>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6">
          <div className="space-y-6">
            <div className="rounded-xl bg-slate-50 border border-slate-100 px-4 py-3">
              ...
              <p className="font-mono font-semibold text-[#1B0A2E]">{pkg.tracking_id}</p>
            </div>
