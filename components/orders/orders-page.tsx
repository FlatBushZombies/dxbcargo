...
export default function OrdersPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      {/* Header */}
      <header className="sticky top-0 z-40 bg-[#1B0A2E] border-b border-white/10 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-white font-bold text-lg">DXB Runners Cargo Admin</h1>
            ...
            <div className="flex items-center gap-3">
              <Button
                ...
                className="bg-purple-500 hover:bg-purple-600 text-white font-semibold rounded-xl h-10 px-4"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#1B0A2E]/5 flex items-center justify-center">
                <PackageIcon className="w-5 h-5 text-[#1B0A2E]" />
              </div>
              <div>
                <p className="text-2xl font-black text-[#1B0A2E]">{packages.length}</p>
          ...
          <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-black text-[#1B0A2E]">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
          {isLoading ? (
            <div className="flex items-center justify-center py-20">
              <div className="w-8 h-8 border-3 border-slate-200 border-t-purple-500 rounded-full animate-spin" />
            </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1.5">
                          <p className="font-mono font-bold text-[#1B0A2E]">{pkg.tracking_id}</p>
                          <button
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="px-3 py-1.5 rounded-lg bg-purple-500/10 text-purple-600 text-xs font-medium border border-purple-500/20">
                          {pkg.transport_type}
                        </div>
                      </div>
