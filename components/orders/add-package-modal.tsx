...
export function AddPackageModal({ onClose, onSuccess }: AddPackageModalProps) {
  ...
  const buildWhatsappMessage = (customerName: string, trackingId: string) => {
    return `Hello ${customerName}, your DXB Runners Cargo package has been created.

Your Tracking ID is: ${trackingId}

Track your shipment anytime:
https://www.dxbrunnerscargo.com/tracking?id=${encodeURIComponent(trackingId)}`
  }
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
          <div className="p-8 text-center">
            ...
            <h2 className="text-2xl font-black text-[#1B0A2E] mb-2">Package Created!</h2>
            ...
            <div className="bg-slate-50 rounded-2xl p-4 mb-6">
              ...
              <div className="flex items-center justify-center gap-3">
                <p className="font-mono text-xl font-black text-[#1B0A2E]">{createdTrackingId}</p>
                <button
                  onClick={handleCopy}
            ...
            <div className="flex gap-3">
              ...
              <Button
                onClick={onSuccess}
                className="flex-1 h-12 rounded-xl bg-[#1B0A2E] hover:bg-[#3B1A5C]"
              >
                Done
              </Button>
            </div>
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-[#1B0A2E]">Add New Package</h2>
